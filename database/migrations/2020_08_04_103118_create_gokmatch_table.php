...
class CreateGokmatchTable extends Migration
{
    /**
     * Run the migrations.
     * 王者荣耀首页展示比赛
    ...
    public function up()
    {
        Schema::create('gokmatch', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('team1winnum')->comment('队伍2胜利局数');
