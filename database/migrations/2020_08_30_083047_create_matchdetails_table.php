...
class CreateMatchdetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('matchdetails', function (Blueprint $table) {
            ...
            $table->string('camp1hero1')->comment('阵营1英雄1');
            $table->text('camp1hero1equipment')->comment('阵营1英雄1装备');
            $table->string('camp1hero2')->comment('阵营1英雄2');
            $table->text('camp1hero2equipment')->comment('阵营1英雄2装备');
            $table->string('camp1hero3')->comment('阵营1英雄3');
            $table->text('camp1hero3equipment')->comment('阵营1英雄3装备');
            $table->string('camp1hero4')->comment('阵营1英雄4');
            $table->text('camp1hero4equipment')->comment('阵营1英雄4装备');
            $table->string('camp1hero5')->comment('阵营1英雄5');
            $table->text('camp1hero5equipment')->comment('阵营1英雄5装备');
            ...
            $table->string('camp2hero1')->comment('阵营2英雄1');
            $table->text('camp2hero1equipment')->comment('阵营2英雄1装备');
            $table->string('camp2hero2')->comment('阵营2英雄2');
            $table->text('camp2hero2equipment')->comment('阵营2英雄2装备');
            $table->string('camp2hero3')->comment('阵营2英雄3');
            $table->text('camp2hero3equipment')->comment('阵营2英雄3装备');
            $table->string('camp2hero4')->comment('阵营2英雄4');
            $table->text('camp2hero4equipment')->comment('阵营2英雄4装备');
            $table->string('camp2hero5')->comment('阵营2英雄5');
            $table->text('camp2hero5equipment')->comment('阵营2英雄5装备');
            $table->timestamps();
        });
    }
