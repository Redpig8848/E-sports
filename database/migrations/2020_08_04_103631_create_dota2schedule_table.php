...
class CreateDota2scheduleTable extends Migration
{
    /**
     * Run the migrations.
     * 刀塔2赛事表
    ...
    public function up()
    {
        Schema::create('dota2schedule', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('teamoneimg')->comment('队伍1图标');
    ...
    {
        Schema::dropIfExists('dota2schedule');
    }
}
